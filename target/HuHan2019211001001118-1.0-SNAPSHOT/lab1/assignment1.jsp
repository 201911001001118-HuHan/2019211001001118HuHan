...
personList.add(new Person("huhan",new Dog("huhan")));
personList.add(new Person("huhan1",new Dog("huhan1")));
...
<c:forEach var="c" items="${requestScope.AllPerson}">
    <c:out value="${c.name}"/>&nbsp;
    <c:out value="${c.dog.name}"/><br>
</c:forEach>
<%
